...
class TriangleBubblePopupBuilder: BubblePopupBuilder {
    ...
    // 获取三角形绘制相关坐标
    func getDrawTriangleLayerRectParams(position: BubblePopupPositionType) -> (startPoint: CGPoint, point1: CGPoint, endPoint: CGPoint) {
        switch position {
        case .top:
...
class TriangleTopBubblePopupBuilder: TriangleBubblePopupBuilder {
    ...
    override func addBubbleFlagView(to bubblePopup: BubblePopup) {
        ...
        let params = getDrawTriangleLayerRectParams(position: .top)
...
class TriangleBottomBubblePopupBuilder: TriangleBubblePopupBuilder {
    ...
    override func addBubbleFlagView(to bubblePopup: BubblePopup) {
        ...
        let params = getDrawTriangleLayerRectParams(position: .bottom)
...
class TriangleLeftBubblePopupBuilder: TriangleBubblePopupBuilder {
    ...
    override func addBubbleFlagView(to bubblePopup: BubblePopup) {
        ...
        let params = getDrawTriangleLayerRectParams(position: .left)
...
class TriangleRightBubblePopupBuilder: TriangleBubblePopupBuilder {
    ...
    override func addBubbleFlagView(to bubblePopup: BubblePopup) {
        ...
        let params = getDrawTriangleLayerRectParams(position: .right)
